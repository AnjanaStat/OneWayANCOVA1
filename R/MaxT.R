#' Finds test statistic value and critical value of Max-T test for testing equality  of treatment effects against ordered alternatives in one-way ANCOVA model with single covariate
#'
...
MaxT<-function(Y,X,k,alpha)
{
  ...
  crit_value<-fun3(data2,N,S,b,k,alpha)
